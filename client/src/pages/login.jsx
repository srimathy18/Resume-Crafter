  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      >
        ...
        <motion.button
          type="submit"
          className='bg-blue-600 w-full text-white py-2 rounded-full transition-all hover:bg-blue-700 mt-6'
        ...
        <motion.img
          onClick={() => {
            setShowLogin(false);
            navigate('/'); // ✅ redirect to home page when clicking close icon
          }}
